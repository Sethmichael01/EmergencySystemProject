...
{
    public partial class NewSQLServerDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Organizations_Sectors_SectorId",
                        column: x => x.SectorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmergencyRequests_Citizens_CitizenId",
                        column: x => x.CitizenId,
                        principalTable: "Citizens",
                        principalColumn: "CitizenId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmergencyRequests_Sectors_SectorId",
                        column: x => x.SectorId,
                        principalTable: "Sectors",
                        principalColumn: "SectorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmergencyRequests_Staffs_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmergencyRequests_CitizenId",
                table: "EmergencyRequests",
                column: "CitizenId");

            migrationBuilder.CreateIndex(
                name: "IX_EmergencyRequests_SectorId",
                table: "EmergencyRequests",
                column: "SectorId");

            migrationBuilder.CreateIndex(
                name: "IX_EmergencyRequests_StaffId",
                table: "EmergencyRequests",
                column: "StaffId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Organizations_SectorId",
                table: "Organizations",
                column: "SectorId");
